  ...
  return (
     ...
     <section className='h-dvh w-full flex flex-col lg:flex-row'>
              <div className='lg:h-full  w-full flex flex-col lg:justify-center justify-end items-center lg:ml-28 lg:mr-4 mx-auto  h-[30vh]'>
                  ...
                  <div>
                      <h2 className='text-[1.5rem] md:text-[4rem] items-center justify-center flex lg:tracking-[-0.1rem] w-full lg:leading-[6rem] font-semibold gap-4 '>
                         DREAMER'S
                          LOUNGE <br />
              ...
              <Image src="/vipHero1.jpg" alt="model" height={ 800 } width={ 800 } quality={100 } className='rounded-full object-contain mx-4' priority />
              </div>
      </section>
  )
}
